...
export const necroticSpells: Spell[] = [
  {
    ...
    school: "Necrotic",
    tier: -1,
    desc: "(Shadowmancer Only.) Deal 1d12+CHA damage to a target within 60 ft. 1/round. Higher Levels: +1d12 every 5 levels.",
    actions: 1,
    roll: "1d12+[CHA]",
  ...
  },
  {
    ...
    school: "Necrotic",
    tier: 0,
    desc: "On a failed WILL save, a target within 60 ft. takes 1d6 damage and moves 10 ft. nearer to you. Repeat until they save or cannot move any longer. High Levels: Increment the die size 1 step every 5 levels (d6 → d8 → d10 → d12 → d20).",
    actions: 1,
    roll: "1d6",
  },
  {
  ...
  },
  {
    ...
    school: "Necrotic",
    tier: 6,
    desc: "A target within 60 ft. dies on a failed WILL save. If they succeed, you drop to 0 HP instead. The target has disadvantage if they are Bloodied, advantage if they are unharmed. Upcast: +1 save DC.",
    actions: 3,
    roll: "",
  },
  {
...
export const lightningSpells: Spell[] = [
  ...
  },
  {
    ...
    school: "Lightning",
    tier: 4,
    desc: "(Reaction, when a creature within 90 ft. takes an action.) Switch the places of one willing creature and another creature in range. If one was the target of an attack or effect, the other becomes the new target. An unwilling target makes a WILL save to resist. Costs 2 Mana and 1 Action while Charged or Dying. Upcast: +1 spell save DC.",
    actions: 2,
    roll: "",
  },
  {
